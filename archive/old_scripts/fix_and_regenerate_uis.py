#!/usr/bin/env python3
"""
Fix and regenerate all three v5.1 review UIs with text display.
This adds the missing English/Hebrew text display that was accidentally omitted.
"""
...
def generate_fixed_v5_1_ui(data, output_file):
    """Generate v5.1 UI with text display added"""

    # Add page segments to each story for text display
    for page in data['pages']:
        for story in page['stories']:
            story['page_segments'] = page['segments']
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Enhanced with criteria breakdown, disqualifiers, weakeners, and full text display</p>
...
{stories_json}
    ...
    <script>
        ...
        // Flatten stories from pages (with page segments for text display)
...
def main():
    print("Fixing and regenerating all v5.1 validation UIs with text display...")
    print()
    ...
    # Generate fixed UIs
    generate_fixed_v5_1_ui(data_2_39, 'v5_1_review_ui_FIXED.html')
    generate_fixed_v5_1_ui(data_40_60, 'v5_1_review_ui_40-60_FIXED.html')

    print()
    print("✓ Fixed UIs generated!")
    print()
    print("The fixed UIs now include:")
    print("  - English and Hebrew text display (side-by-side)")
    print("  - Story segments highlighted with yellow background")
    print("  - Full page context (all segments shown)")
    print("  - Criteria breakdown")
    print("  - Disqualifiers and weakeners")
    print("  - Self-check adjustments")
    print("  - Classification reasoning")
    print()
    print("Next: Review the fixed UIs, then replace the old ones.")
