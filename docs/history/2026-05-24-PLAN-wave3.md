...
**Source plan:** `docs/history/2026-05-17-PLAN-kiddushin-fixes.md` (Wave 3 section).
...
- [ ] **0.4** Record today's gate numbers in `docs/history/2026-05-24-PLAN-wave3.md` (this file, under "Session gate" below).
