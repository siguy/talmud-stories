...
| 2026-09-25 | **R-B4 — the Gemara's commentary on a story is not the story** (Jeff, 2026-09-23, Kiddushin 39b 8-10 and Yevamot 15a), even where it revises the story or adds a detail. Stronger than R-B2: excluded, and inside as well as after | Kiddushin golden 39b 8-8 → **7-7**. In the twin-pass question. Not yet in Stage 2 or Stage 4 — a detector change needs a scored two-arm run. Also indicated, not settled: on 106b he calls the Gemara's ruling *"not part of the narrative at all"*, leaning `jeff:boundary-end-rule` towards cut | [`jeff-verdicts`](../findings/2026-09-25-jeff-verdicts-scope-commentary-reports.md) |
