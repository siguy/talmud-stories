...
1. **Run detection** → `src/story_detector_v7.py` or `scripts/run_ketubot_61_112.py`
2. **Generate UI** → `validation/generators/generate_review_ui.py` (auto-generated by run scripts)
