...
def load_v5_1_results(filepath='results/ketubot/v5/pages_2-39.json'):
    """Load v5.1 results"""
...
def load_jeff_validation(filepath='validation/feedback/jeff_v4.1_validation.json'):
...
def main():
    v5_1_file = 'results/ketubot/v5/pages_2-39.json'
    jeff_file = 'validation/feedback/jeff_v4.1_validation.json'
