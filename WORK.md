...
| [A custom that frames a one-time event is still a story (Gittin 57a, Beitar)](work/2026-09-02-habitual-frame.md) | detection, classification | gittin | — |
| [Include the introducing formula in the story start — Jeff ruled, so build it](work/2026-09-02-opening-formula.md) | boundaries | — | — |
...
|---|---|---|
| `build-canonical-hazard` | `talmud-stories` | **1 FILES** |
| `gittin-detection-run` | `kiddushin-recall-boundary-c52c91` | **5 FILES** |
| `google-api-key-env-f5d39a` | `state-work-review-40b153` | clean |
<!-- board-live:end -->

## Done — 21 items, never deleted
...
<!-- board-checksum: 60e5ea98244faf3c -->
