...
| [Re-run every tractate on the current detector, once the pending changes are settled](work/2026-09-03-rerun-all-tractates.md) | detection, classification, boundaries | ketubot, kiddushin, gittin | — |
...
|---|---|---|
| `quasi-speech-act-screen` | `talmud-stories` | **5 FILES** |
...
<!-- board-checksum: 616f2c2c096b789c -->
