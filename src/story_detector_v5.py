#!/usr/bin/env python3
"""
Talmud Story Detection v5.1: Categorical Classification with Jeff's v4.1 Validation Improvements
...
CURATED_EXAMPLES = {
    ...
    "not_a_story_examples": [
        ...
        {
            "ref": "Ketubot 8a",
            "name": "Levi Wedding Visit (Jeff v4.1 #1)",
            "hebrew": "לוי איקלע לבי רבי",
            "english": "Levi visited Rabbi Yehuda HaNasi's house during his son Rabbi Shimon's wedding celebration.",
            "disqualifier": "simple_report",
            "why_not": "Simple report of attendance. No causality, no change. Just 'X visited Y'.",
            "classification": "NOT_A_STORY",
            "jeff_notes": "FALSE - no causality or change"
        },
        {
            "ref": "Ketubot 14b",
            "name": "Girl Drawing Water (Jeff v4.1 #7)",
            "english": "There was an incident involving a young girl drawing water who was raped.",
            "disqualifier": "no_causality",
            "why_not": "Two events but NO causal relationship. Drawing water didn't CAUSE the rape. Events are sequential, not causal.",
            "classification": "NOT_A_STORY",
            "jeff_notes": "There are two events but not a causal relationship or change. The narrative relates that two events happened: the girl went to draw water and she was raped. But there is no causal relationship that is necessary for a story."
        },
        {
            "ref": "Ketubot 17a",
            "name": "Rabbi Stating Legal Opinion (Jeff v4.1 #13)",
            ...
            "why_not": "Rabbi name appears to ATTRIBUTE legal ruling, not as character in narrative. This is legal opinion, not story.",
            "classification": "NOT_A_STORY",
            "jeff_notes": "FALSE - rabbi stating legal opinion, not character in story"
        },
        {
            "ref": "Ketubot 31a",
            "name": "Arrow Hypothetical (Jeff v4.1 #30)",
            "english": "Rabbi Avin discusses a case of shooting an arrow and causing damage.",
            "disqualifier": "rabbi_legal_opinion",
            "why_not": "Rabbi discussing HYPOTHETICAL legal case. No account of anyone actually shooting an arrow. Just legal analysis.",
            "classification": "NOT_A_STORY",
            "jeff_notes": "This is a legal ruling, not a story. The rabbis who make statements here are not characters within a story. R. Avin is making a ruling about someone who shoots an arrow, but that is simply a hypothetical legal case. There is no account of anyone actually shooting an arrow."
        }
    ]
}
...
DISQUALIFIERS = {
    ...
    "rabbi_legal_opinion": {
        ...
        "reason": "Rabbi name appears to ATTRIBUTE legal ruling, not as character in narrative. Distinguish: 'Rav X said [legal opinion]' (not story) vs 'A man came before Rav X and Rav X ruled' (is story)"
    }
}
...
- **RABBI STATING LEGAL OPINION**: Rabbi name appears to ATTRIBUTE legal ruling, NOT as character
  ...
  ✗ "Rabbi X discusses a case of..." (hypothetical)
...
5. CAUSALITY TEST (STRICT):
   ...
   - Are events causally connected, or just sequentially reported?
   - "X happened, then Y happened" (sequential) ≠ story
   - "X caused Y, which caused Z" (causal) = story
   - Example: "Girl drew water. Girl was raped." = Two events, NO causation → NOT_A_STORY
   - If no causation → NOT_A_STORY
   - If minimal causation → downgrade to LOW_CONFIDENCE

6. CHANGE TEST (STRICT):
   "What is different at the end compared to the beginning?"
   - Is this a transformation or just a report of actions?
   - Simple report ("He came and recited blessing") = NO change → NOT_A_STORY
   - Actions without transformation ("Was greeted with song") = NO change → NOT_A_STORY
   - Actual change ("Friends close → friends distanced") = Change → Story
   - If nothing changed → NOT_A_STORY

7. RABBI AS CHARACTER TEST:
   "Is the rabbi a CHARACTER in a narrative, or just ATTRIBUTING a legal opinion?"
   - "Rabbi X said [legal ruling]" = Attribution, NOT a character → NOT_A_STORY
   - "A man came before Rabbi X and Rabbi X ruled..." = Rabbi IS character → Story
   - If rabbi only appears stating opinions → NOT_A_STORY
  ...
  "validations": [
    {{
      ...
      "self_check_results": {{
        ...
        "rabbi_character_test": {{"passed": true/false, "role": "character|attribution", "note": "..."}}
      }},
      "tests_passed": <0-7>,
...
def analyze_tractate_v5(tractate: str, start_page: int = 2, end_page: int = 10):
    ...
    """
    print("=" * 70)
    print(f"Talmud Story Detection v5.1 - Categorical Classification")
