---
title: Yevamot — detection
capability: [detection]
tractate: [yevamot]
blocked_by: [2026-08-30-yevamot-triage, 2026-08-30-two-amud-header-parser]
awaiting: []
writes: [results/detection/yevamot.json, src/story_detector_v11.py]
finding:
superseded_by:
---
