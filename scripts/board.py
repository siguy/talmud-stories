...
def render_state() -> str:
    g, r, el, gl = gates(), rulers(), expert_lists(), goldens()
    its = items()
    ...
    for t in TRACTATES:
        ...
        # Triage, Classification and Boundaries have NO on-disk artifact carrying their
        ...
        triage = "STATUS · B" if t == "ketubot" else ""
