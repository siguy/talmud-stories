...
| ~~`jeff:speech-act-policy`~~ **ANSWERED 2026-09-23** | **Settled on the three cases the page put to him:** Ketubot 7a:1 and 112a:11 `borderline` (*"there is conflict and some implied change"*; being mocked is conflict, not an event), 15a:0 `no` (*"not enough of the incident is given"*). The rule we proposed is now R-C2: speech with no event beyond speaking is BORDERLINE with conflict, NOT without. Applied to the Ketubot golden, with 10 more entries where he had already written "borderline" in his own words. *History:* 2026-09-01 he answered "no hard and fast rules… unless we make one" and ruled three Gittin cases individually. | closed — [R-C2](../docs/STORY_RULES.md), [finding](../docs/findings/2026-09-25-jeff-verdicts-scope-commentary-reports.md) |
| `jeff:scope-edges` | Your scope is *"rabbis and post-biblical figures"* (2026-09-23). Three edges we read as **in** — confirm or correct: (1) Elijah appearing to a rabbi (Gittin 6b, Kiddushin 40a); (2) a biblical figure cited *inside* a rabbinic story (Kiddushin 32b — Rabban Gamliel serving, justified by Abraham); (3) post-biblical non-rabbis — Titus, King Yannai, Agrippa. | Decides R-S1's edge. All three are in the golden now; a "no" removes entries, so it is asked, not assumed. | **Free ask** — one line, rides with the next email |
...
### Email 2 — sent 2026-09-16, **answered 2026-09-23: all 10 verdicts**

He answered every passage and, for the first time, used the Hebrew start/end quote
fields (4 of 10). What came back is in
[`2026-09-25-jeff-verdicts-scope-commentary-reports`](../docs/findings/2026-09-25-jeff-verdicts-scope-commentary-reports.md):
a scope rule (R-S1), a boundary rule (R-B4), a classification rule (R-C5), and R-C2
settled. The record of what was sent follows.
...
|---|---|---|
| The 2026-09-01 email said *"All 59 we called 'certain' are on your list."* | **False for two of them.** Gittin **57b:0-4** (Nebuzaradan and Zechariah's blood) and **68a:7-12** (Solomon and Ashmedai) are `YES`-tier and on no list of his. **Resolved 2026-09-23:** he judged both real stories about biblical characters, out of scope (R-S1) — so the 2005 list omitting them was the rule, not a gap. They were counted as matches by the **loose** window, which is up to 14 segments wide and credited a neighbouring story on the same daf — the third and fourth known instance of that failure. The second half of the claim — *"none of the extras we propose is one"* — still stands. Both passages go on the next page he sees. | [`gittin_golden`](../docs/findings/2026-09-02-gittin-golden.md), [`two-unjudged-yes`](../work/done/2026-09-02-gittin-two-unjudged-yes.md) |
...
| 2026-09-16 | [Email 2](2026-09-16-email-jeff-DRAFT.md) — the 10-passage page: twins, speech acts, two unjudged Gittin extras | **all 10 verdicts, 2026-09-23**, with Hebrew quote fields used for the first time — [findings](../docs/findings/2026-09-25-jeff-verdicts-scope-commentary-reports.md) |
